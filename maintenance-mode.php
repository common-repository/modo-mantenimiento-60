...
/*
    ----------------------------------------------------------------------------
         ...
         |____________________________________________________|
	                  ...
	                  Copyright © acidc00l & Michael Wöhrer 
		...
		$this->AddContentMain(__('Splash Page Theme',$this->g_info['ShortName']), "
			<p>
				<select name='mamo_theme'>
					...
					<option value='wordpress'" . ($this->COPTHTML('mamo_theme') == 'wordpress' ? ' selected="selected"' : '') . ">" . __('Flash Theme',$this->g_info['ShortName']) . "</option>
